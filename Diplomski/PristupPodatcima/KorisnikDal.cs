...
namespace PristupPodatcima
{
    public class KorisnikDal
    {
        ...
        public Korisnik DajKorisnikaPoKorimeLozinka(string ime, string psw)
        {
            ...
            string strSelect = @"select korisnik_id as KorisnikId, lozinka as Lozinka, email as Email, ime as Ime, prezime as Prezime from dbo.korisnik
            ...
            cmd.Parameters.Add("@korisnicko_ime", SqlDbType.VarChar).Value = ime;
